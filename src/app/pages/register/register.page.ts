...
export class RegisterPage implements OnInit, AfterViewInit {
  ...
  constructor(public fb: FormBuilder, private router: Router, public LoadingCtrl: LoadingController, public AuthService: FirestoreService, public alertController: AlertController) {
